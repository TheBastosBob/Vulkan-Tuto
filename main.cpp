...
const std::string MODEL_PATH = "/Users/bastiencantet/Documents/dev/perso/vulkan/Vulkan-Tuto/viking_room.obj";
const std::string TEXTURE_PATH = "/Users/bastiencantet/Documents/dev/perso/vulkan/Vulkan-Tuto/viking_room.png";
...
public:
    ...
    bool checkValidationLayerSupport() {
        //LOG(INFO) << "Check Validation Layer Support";
        uint32_t layerCount;
...
private:
    ...
    bool checkMissingExtension() {
        ...
        for (const auto &extension: extensions) {
            //LOG(INFO) << "Available extension: " << extension.extensionName;
        }
    ...
    void createDescriptorSetLayout() {
        ...
        if (int res =  vkCreateDescriptorSetLayout(_device, &layoutInfo, nullptr, &descriptorSetLayout) != VK_SUCCESS) {
...
//        }
    ...
    void createImageViews() {
        ...
        for (uint32_t i = 0; i < _swapChainImages.size(); i++) {
            swapChainImageViews[i] = createImageView(_swapChainImages[i], _swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT);
        }
    }
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
        //LOG(INFO) << "Populate Debug Messenger Create Info";
        createInfo = {};
    ...
    void mainLoop() {
        ...
        while (!glfwWindowShouldClose(_window)) {
            ...
            if (currentTime - lastTime >= 1.0) {
                glfwSetWindowTitle(_window, std::to_string(frameCount).c_str());
                frameCount = 0;
                lastTime += 1.0;
            }
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        /*
         *  One ffectue des calculs permettant la projection X,Y,Z
         */
    ...
    void createDescriptorSets() {
        ...
        if (int res = vkAllocateDescriptorSets(_device, &allocInfo, descriptorSets.data()) != VK_SUCCESS) {
            std::string r = std::to_string(res);
...
int main(int ac, char **av) {
    ...
    //check if folder log exists if not create it
